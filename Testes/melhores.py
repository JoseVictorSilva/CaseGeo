...
def MelhoresVariaveis():
    ...
    # Pega variaveis teste e usa o encode para facilitar no potencial
    ...
    # Usa o Select KBest para testar as variáveis mais impactantes
    ...
    # Usa o ExtraTreesClassifier para testar as variáveis mais impactantes
